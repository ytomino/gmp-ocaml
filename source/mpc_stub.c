...
CAMLprim value mlmpc_c_abs(value prec, value mode, value x)
{
	...
	mpfr_init2(result_value, Long_val(Field(prec, 0)));
	mpc_abs(result_value, C_val(x), Rnd_val(mode));
	CAMLreturn(result);
}
...
CAMLprim value mlmpc_c_add_int(value prec, value mode, value left, value right)
{
	...
	mpc_ptr result_value = C_val(result);
	mpc_init3(result_value, Long_val(Field(prec, 0)), Long_val(Field(prec, 1)));
	mpc_add_si(result_value, C_val(left), Long_val(right), Crnd_val(mode));
	CAMLreturn(result);
}
...
CAMLprim value mlmpc_c_pow_int(value prec, value mode, value base, value exponent)
{
	...
	mpc_ptr result_value = C_val(result);
	mpc_init3(result_value, Long_val(Field(prec, 0)), Long_val(Field(prec, 1)));
	mpc_pow_ui(result_value, C_val(base), Long_val(exponent), Crnd_val(mode));
	CAMLreturn(result);
}
...
CAMLprim value mlmpc_c_scale(value prec, value mode, value fraction, value base, value exponent)
{
	...
	mpc_init3(result_value, real_prec, Long_val(Field(prec, 1)));
...
CAMLprim value mlmpc_c_sqrt(value prec, value mode, value x)
{
	...
	mpc_ptr result_value = C_val(result);
	mpc_init3(result_value, Long_val(Field(prec, 0)), Long_val(Field(prec, 1)));
	mpc_sqrt(result_value, C_val(x), Crnd_val(mode));
	CAMLreturn(result);
}
...
CAMLprim value mlmpc_c_of_int(value prec, value mode, value x)
{
	...
	mpc_ptr result_value = C_val(result);
	mpc_init3(result_value, Long_val(Field(prec, 0)), Long_val(Field(prec, 1)));
	mpc_set_si(result_value, Long_val(x), Crnd_val(mode));
	CAMLreturn(result);
}
...
CAMLprim value mlmpc_c_make_int(value prec, value mode, value r, value i)
{
	...
	mpc_ptr result_value = C_val(result);
	mpc_init3(result_value, Long_val(Field(prec, 0)), Long_val(Field(prec, 1)));
	mpc_set_si_si(result_value, Long_val(r), Long_val(i), Crnd_val(mode));
	CAMLreturn(result);
}
